...
(ggplot(glmdata,
       ...
       ) + labs(title = "受教育年") + facet_grid(term ~ .) + geom_boxplot()) 

(ggplot(glmdata,
       aes(x = success_on_bill,
           y = (myown_ses)
           )
       ) + labs(title = "職業社經地位") + facet_grid(term ~ .) + geom_boxplot()) 
...
) + labs(title = "家庭收入所屬組別") + facet_grid(term ~ .) + geom_bar(position="fill"))

(ggplot(glmdata,
       aes(x = success_on_bill,
           y = (myown_family_income)
           )
       ) + labs(title = "家庭收入") + facet_grid(term ~ .) + geom_boxplot()) 

(ggplot(glmdata,
       aes(x = success_on_bill,
           y = (myown_family_income_stdev)
           )
       ) + labs(title = "家庭收入多少標準差") + facet_grid(term ~ .) + geom_boxplot()) 

(ggplot(glmdata,
       aes(x = myown_dad_ethgroup,
           fill = (success_on_bill)
       )
) + labs(title = "父親族群") + facet_grid(term ~ .) + geom_bar(position="fill"))

(ggplot(glmdata,
       aes(x = myown_mom_ethgroup,
           fill = (success_on_bill)
       )
) + labs(title = "母親族群") + facet_grid(term ~ .) + geom_bar(position="fill"))

(ggplot(glmdata,
       aes(x = myown_selfid,
           fill = (success_on_bill)
       )
) + labs(title = "自我族群") + facet_grid(term ~ .) + geom_bar(position="fill"))

(ggplot(glmdata,
       aes(x = myown_approach_to_politician_or_petition,
           fill = (success_on_bill)
       )
) + labs(title = "有無請願或找政治人物") + facet_grid(term ~ .) + geom_bar(position="fill"))

(ggplot(glmdata,
       aes(x = myown_protest,
           fill = (success_on_bill)
       )
) + labs(title = "有無抗議") + facet_grid(term ~ .) + geom_bar(position="fill"))

(ggplot(glmdata,
       aes(x = myown_vote,
           fill = (success_on_bill)
       )
) + labs(title = "有無投票") + facet_grid(term ~ .) + geom_bar(position="fill"))
