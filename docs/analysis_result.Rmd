...
kable(indattitude_variable_table, format = "html") %>% kable_styling(bootstrap_options = c("striped", "hover"))
```
...
kable(partyconstituency_variable_table, format = "html") %>% kable_styling(bootstrap_options = c("striped", "hover"))
```
