...
```{r echo=FALSE}
model_indp_var <- c("myown_selfid", "myown_factoredses", "myown_factoredparticip","gap_sex", "gap_eduyr", "gap_ses", "gap_ethnicity", "gap_age", "days_diff_survey_bill","elec_dist_type","legislator_party","incumbent","pp_agendavoting","pp_lawamendment")
...
if ({ordered_logistic_to_analy_repre_response<-TRUE; ordered_logistic_to_analy_repre_response}) {
  result_repre_response_on_all_bills <- custom_parallel_lapply(overall_district_legislators_only_power_dfdata,function(dataset_for_analysis) {
    #dataset_for_analysis <- overall_district_legislators_only_power_dfdata[[4]] #complete.cases(overall_district_legislators_only_power_dfdata[[4]][,c(model_indp_var,model_dep_var)])#  %>%
      #.[,]
    models_respondopinion_by_district_legislator <- dataset_for_analysis %$%
  ...
  exportvar=c("overall_district_legislators_only_power_dfdata","respondopinion_by_district_legislator_formula"))
    ...
    model_tables <- custom_parallel_lapply(models_respondopinion_by_district_legislator,function(model_respondopinion_by_district_legislator) {
...
* Young, Iris Marion. (1990). Justice and the Politics of Difference. Princeton, N.J.: Princeton University Press ??保護環境更重要的事","v26d 請問您同不同意以下說法?除非大家都一起為環境盡力,否則您一個人做沒有用","v79 對您來說,您覺得日常生活中的環保行為容不容易做到?"),#2010env
  c("v67f 請問您贊不贊成公眾的事不好辦,所以最好不要插手的說法?"),#2010overall
  c("d16c 您覺得您對於國家重要的政治議題,都有相當的瞭解","d16d 您認為大多數人都比您更瞭解政治與政府"),#2016citizen
  fill = ""
))
...
political_particip_variable_table<-as.data.frame(rowr::cbind.fill(
  c("v28 您有沒有做過請願(簽名)連署(0.815)","v29 您有沒有因為政治,倫理道德,或是環保的理由拒絕購買或是特別去購買某些產品(0.623)","v30 您有沒有參加示威遊行(0.840)","v31 您有沒有參加政治集會或造勢活動(0.777)","v32 您有沒有找過政治人物或公務人員表達您的看法(0.785)","v33 您有沒有捐錢給某個社會或政治活動,或者幫他們募款(0.562)","v34 您有沒有透過媒體去表達您的看法(0.810)","v35 您有沒有參加網路上的政治論壇或討論群組(0.725)","v36 請問您有沒有加入和參與政黨(0.394)","v37 請問您有沒有加入和參與工會,工商同業公會,職業同業公會(0.240)","v38 請問您有沒有加入和參與宗教團體或教會(0.396)","v39 請問您有沒有加入和參與運動,休閒或文化團體(0.512)","v40 請問您有沒有加入和參與其他自願性社團(0.537)","0.415"),
  c("v34 請問您是環保團體的成員嗎?(0.712)","v35a 在過去五年間,請問您有沒有做過以下的事情:連署一份有關環保議題的請願書(0.699)","v35b 在過去五年間,請問您有沒有做過以下的事情:捐款給環保團體(0.704)","v35c 在過去五年間,請問您有沒有做過以下的事情:參加有關環保議題的抗議行動或遊行(0.603)","","","","","","","","","","0.464"),
  c("v79a 在過去的一年,您有沒有向政府官員,民意代表或政黨反映意見提出要求?(0.743)","v79b 在過去的一年,您有沒有向大眾?