...
indattitude_variable_table<-as.data.frame(rowr::cbind.fill(
  c("v95 關於台灣和大陸的關係,您的看法是什麼","1儘快統一","2儘快獨立","3維持現狀,以後走向統一","4維持現狀,以後走向獨立","5維持現狀,看情況再決定獨立或統一","6永遠維持現狀","v96 您同不同意若台灣宣布獨立後,仍可和中共維持和平,則台灣應該成為一個新國家","1非常同意","2同意","3不同意","4非常不同意","v97 您同不同意若大陸和台灣在經濟,社會,政治各方面的條件相當,則兩岸應該統一","1非常同意","2同意","3不同意","4非常不同意"),
  c("","","",""),
